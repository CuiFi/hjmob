...
class NewsContent extends Component {
	...
	componentWillMount() {
		...
		fetch("http://old.hejianzhiyang.com/Api/getDataByid?sheet=daquan&id=" + this.props.match.params.id ,myList).then(response => response.json()).then(json => this.setState({listText:json}));
